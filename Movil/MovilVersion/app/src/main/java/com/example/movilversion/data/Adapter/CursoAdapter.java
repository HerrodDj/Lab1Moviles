package com.example.movilversion.data.Adapter;
...
public class CursoAdapter extends RecyclerView.Adapter<CursoAdapter.MyViewHolder> implements Filterable {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView titulo1, titulo2, description, car;
        //two layers
        ...
        public MyViewHolder(View view) {
            ...
            car = view.findViewById(R.id.carlabl);
    ...
    public void onBindViewHolder(CursoAdapter.MyViewHolder holder, int position) {
        ...
        holder.car.setText(curso.getCodigoCarrera());
    }
